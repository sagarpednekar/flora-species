...
export interface ApiFloraSpeciesOneFloraSpeciesOne
  extends Schema.CollectionType {
  collectionName: 'flora_species';
  info: {
  ...
  attributes: {
    drug_name: Attribute.String;
    sanskrit_name: Attribute.String;
    ...
    createdBy: Attribute.Relation<
      'api::flora-species-one.flora-species-one',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::flora-species-one.flora-species-one': ApiFloraSpeciesOneFloraSpeciesOne;
